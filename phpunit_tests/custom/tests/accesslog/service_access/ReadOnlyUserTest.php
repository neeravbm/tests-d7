 ...
 */
class ReadOnlyUserTest extends \PHPUnit_Framework_TestCase {
   ...
   * ReadOnly user name.
   */
  CONST READONLY_USER = 'asheth';

  /**
   * Truncate the accesslog table.
   * Create a contract as an administrator.
   * Log in as a Read Only user and download files associated with the contract.
   */
  public static function setUpBeforeClass() {
    ...
    $userObject = User::loginProgrammatically(self::READONLY_USER);
