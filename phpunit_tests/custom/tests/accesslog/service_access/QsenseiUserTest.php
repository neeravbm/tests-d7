...
/**
 * Class QsenseiUserTest
 *
 * @task SHER-53
 * @test SHER-75
 * @package tests\phpunit_tests\custom\tests\Accesslog\ServiceAccess
 */
class QsenseiUserTest extends \PHPUnit_Framework_TestCase {
   ...
   * Qsensei user name.
   */
  CONST QSENSEI_USER = 'qsearchbot';

  /**
   * Truncate the accesslog table.
   * Create a contract as an administrator.
   * Log in as a Qsensei user and download files associated with the contract.
   */
  public static function setUpBeforeClass() {
    // Log in as a Qsensei user.
    db_truncate('accesslog')->execute();

    self::createContractAsAdministratorUser();

    $userObject = User::loginProgrammatically(self::QSENSEI_USER);
